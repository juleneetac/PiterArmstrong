...
public class UserDAOImpl implements UserDAO {
    ...
    public Boolean addUser(String nick, String password) {
        ...
        try {
            ...
            userID = (Integer) session.getIDverify(User.class, usernew.getNickname(), usernew.getPassword()); // aqui comprueba si el id ya esta o no
    ...
    public User loginUser(User user) throws UserNotFoundException{  //se hace el login
        ...
        try {
            session = FactorySession.openSession();
            userID = (Integer) session.getIDverify(User.class, user.getNickname(), user.getPassword());
    ...
    public void updateUser(User user) throws UserNotFoundException {
        ...
        try {
            session = FactorySession.openSession();
            userID = (Integer) session.getID(User.class, user.getNickname());
